        ...
        switch(type){
            ...
            case "directional":
                ...
                for(let i=0;i<dirs.length;i++){
                    this.dirAttackArea[dirs[i]]=this.scene.add.rectangle( offsets[i].x, offsets[i].y, sizes[i].x,sizes[i].y, 0xd100ab,0.25).setVisible(false);
                    this.dirAttackArea[dirs[i]].setStrokeStyle(1, 0xd100ab, 0.8);
